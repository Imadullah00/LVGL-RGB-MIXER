...
lvgl/examples/libs/tjpgd/%.o lvgl/examples/libs/tjpgd/%.su lvgl/examples/libs/tjpgd/%.cyclo: ../lvgl/examples/libs/tjpgd/%.c lvgl/examples/libs/tjpgd/subdir.mk
...
clean-lvgl-2f-examples-2f-libs-2f-tjpgd:
	-$(RM) ./lvgl/examples/libs/tjpgd/lv_example_tjpgd_1.cyclo ./lvgl/examples/libs/tjpgd/lv_example_tjpgd_1.d ./lvgl/examples/libs/tjpgd/lv_example_tjpgd_1.o ./lvgl/examples/libs/tjpgd/lv_example_tjpgd_1.su
